...
The carried analysis uses the **[Spark](https://spark.apache.org/docs/2.1.0/) 2.1.0** general-purpose cluster computing system to run the classification models. The machine configuration is as follows: MacBook Pro (13-inch, Mid 2012), Processor: 2.5 GHz Intel Core i5, RAM: 16 GB.
